...
## Exercise: Level 1
# Question 1
# Declare a function add_two_numbers. It takes two parameters 
...
# Question 3
# Write a function called add_all_nums which takes arbitrary number
...
def solve_quadratic_eqn(a,b,c,x):
    quadratic_eqn = a*x*x + b*x + c
    return "quadratic_soln = ", quadratic_eqn
print(solve_quadratic_eqn(2,4,2,1))
...
# as a parameter and it returns a capitalized list of items
def capitalize_list_items(lst):
    cap_lst = []
    for i in lst:
        cap_lst.append(i.upper())
    return cap_lst
print(capitalize_list_items(["abdoul", "bashir", "cash"]))
...
# Write a function which checks if all the 
# items of the list are of the same data type.
def items_types(lst):
    items =[]
    for i in lst:
        items.append(type(i))
...
# Write a function which check if provided variable 
...
# should return 10 or 20 most populated countries in descending order.